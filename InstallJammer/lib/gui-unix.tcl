...
#SV default -> configure
option add *Installjammer*background         [style configure . -background]
option add *Installjammer*selectForeground   [style configure . -selectforeground]
option add *Installjammer*selectBackground   [style configure . -selectbackground]
...
option add *Installjammer*Menu.activeBackground \
    [style configure . -selectbackground]
option add *Installjammer*Menu.activeForeground \
    [style configure . -selectforeground]

option add *Installjammer*Table.borderWidth            1

tk_setPalette [style configure . -background]
